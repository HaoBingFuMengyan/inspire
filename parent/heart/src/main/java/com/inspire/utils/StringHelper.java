...
public class StringHelper {
     ...
     *
     * @param date1
     *            <String>(第一个日期),date2<String>(第二个日期)
     * @return int
     */
     ...
     *
     * @param year
     *            <int>,startMonth<int>,endMonth<int>
     * @return List
     */
     ...
     *
     * @param startDateStr
     *            <String>(开始日期),startMonth<String>(结束日期)
     * @return List 周末日期集合
     */
...
//    }
    ...
    public static String numToChinese(int number) {
        String[] chinese = new String[] { "〇", "一", "二", "三", "四", "五", "六", "七", "八", "九" };
