...
<div class="login_box">
    ...
    <div class="login">
        ...
        <form id="inputForm" action="${ctx}/login.html" method="post">
            <input name="susername" type="text" value="用户名" onfocus="this.value=''"
                   onblur="if(this.value==''){this.value='用户名'}">
            <input name="spassword" type="password" id="password" placeholder="密码" onfocus="this.placeholder=''"
                   onblur="if(this.placeholder==''){this.placeholder='密码'}"/>
            <input name="checkcode" type="text" id="checkcode" placeholder="验证码" maxlength="4"
                   onfocus="this.placeholder=''" onblur="if(this.placeholder==''){this.placeholder='验证码'}"/>
